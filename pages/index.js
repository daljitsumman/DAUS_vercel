			...
			<Row style={{ marginTop: '30px' }}>
				<Col lg="3" style={{ 'padding-right': '50px' }}>
					<div style={{ 'min-height': '400px' }}>
						...
						<Select options={options} onChange={handleBoroughDropdownEvent} />
						...
						{selectedDropdownPcnValue != '' && (
							<Fragment>
								...
								<Select options={getPractices()} placeholder="Select Practice" value={selectedDropdownPracticeValue} onChange={handlePracticeDropdownEvent} />
							</Fragment>
						)}
					</div>

					{/**selectedDropdownPracticeValue && <Calendar onChange={onChange} value={value} />**/}
				</Col>
				<Col lg="9">
					<RightPane borough={selectedBorough} pcn={selectedDropdownPcnValue.value} practise={selectedDropdownPracticeValue.value}></RightPane>
				</Col>
			</Row>
		</Fragment>
	);
